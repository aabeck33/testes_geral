...
, areaocor.tbs11 as areaocorrencia, equipo.tbs013 as equipamento
...
WHERE str.idstruct = 'Decisão141027113714228' and str.idprocess=wf.idobject)) else datediff(dd, cast(format(form.tds001,'yyyy/MM/dd') as date), getdate()) end > 25 then 'Em atraso' else 'Em dia' end as tempoaprovfin
