...
left join DYNtds054 alcoa on alcoa.oid = form.OIDABCQ9G6DQOKD8P4
left join DYNsimnao iid on iid.oid = form.OIDABC15Y2CPD8UT0G
left join DYNtds055 cfrd on cfrd.oid = form.OIDABCHBARQW3QRTLX
