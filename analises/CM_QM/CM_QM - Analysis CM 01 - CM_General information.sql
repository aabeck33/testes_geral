...
, CASE form.tds106 WHEN 1 THEN 'Yes' WHEN 2 THEN 'No' END AS Impact_Regulatory
, CASE form.tds163 WHEN 1 THEN 'Yes' WHEN 2 THEN 'No' END AS Impact_Safety
, CASE form.tds016 WHEN 1 THEN 'Yes' WHEN 2 THEN 'No' END AS  Criticality
