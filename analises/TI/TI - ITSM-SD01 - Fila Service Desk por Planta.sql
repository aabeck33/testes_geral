    ...
    FROM
        ...
        FROM
            (SELECT
                ...
                120) AS DTFINISH,
                T0_OUTER.T0__ITSM004_1,
                T0_OUTER.T0__ITSM034_2,
                T0_OUTER.T0__ITSM035_0,
                T0_OUTER.T0__ITSM006_1,
                T0_OUTER.T0__ITSM002_1,
                T0_OUTER.T0__ITSM003_1,
                T0_OUTER.T0__ITSM036_1 
            FROM
                WFPROCESS WFP 
            LEFT OUTER JOIN
            ...
            LEFT OUTER JOIN
                (
                    SELECT
                        FORMREG.CDASSOC,
                        T0.ITSM004 AS T0__ITSM004_1,
                        T0.ITSM034 AS T0__ITSM034_2,
                        T0.ITSM035 AS T0__ITSM035_0,
                        T0.ITSM006 AS T0__ITSM006_1,
                        T0.ITSM002 AS T0__ITSM002_1,
                        T0.ITSM003 AS T0__ITSM003_1,
                        T0.ITSM036 AS T0__ITSM036_1 
                    FROM
