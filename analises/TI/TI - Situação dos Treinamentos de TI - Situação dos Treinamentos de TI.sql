select usr.cdleader,usr.cduser,usr.nmuser, cou.nmcourse, case treusr.fgpend when 2 then 'Executado' else 'Pendente' end Status
...
inner join aduser usr on usr.cduser = treusr.cduser and usr.fguserenabled = 1
