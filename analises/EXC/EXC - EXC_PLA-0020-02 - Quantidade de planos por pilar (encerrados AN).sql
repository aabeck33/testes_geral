...
where gntype.CDGENTYPEOWNER = 53 and actp.nmactivity like '0020 - %'  and actp.fgstatus = 5 and case when charindex(' - ', actp.nmactivity, 1) = 0 or charindex(' - ', actp.nmactivity, 8) = 0 then 'N/A' else 
