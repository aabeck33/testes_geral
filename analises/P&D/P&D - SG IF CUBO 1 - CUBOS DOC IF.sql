select rev.iddocument, rev.nmtitle, gnrev.idrevision, rev.cdrevision,rev.cdcategory
...
, case when cast(cast(stag.NRCYCLE as varchar(255))+cast(stag.FGSTAGE as varchar(255))+cast(stag.NRSEQUENCE as varchar(255))+cast(stag.CDMEMBERINDEX as varchar(255)) as bigint) =
       (select min(cast(cast(stag2.NRCYCLE as varchar(255))+cast(stag2.FGSTAGE as varchar(255))+cast(stag2.NRSEQUENCE as varchar(255))+cast(stag2.CDMEMBERINDEX as varchar(255)) as bigint))
       ...
       datediff(dd,(select stag3.dtapproval from GNREVISIONSTAGMEM stag3
                    where cast(cast(stag3.NRCYCLE as varchar(255))+cast(stag3.FGSTAGE as varchar(255))+cast(stag3.NRSEQUENCE as varchar(255))+cast(stag3.CDMEMBERINDEX as varchar(255)) as bigint) = 
                           (select max(cast(cast(stag2.NRCYCLE as varchar(255))+cast(stag2.FGSTAGE as varchar(255))+cast(stag2.NRSEQUENCE as varchar(255))+cast(stag2.CDMEMBERINDEX as varchar(255)) as bigint)) as code
        from GNREVISIONSTAGMEM stag2
        where stag2.cdrevision = stag.cdrevision and cast(cast(stag2.NRCYCLE as varchar(255))+cast(stag2.FGSTAGE as varchar(255))+cast(stag2.NRSEQUENCE as varchar(255))+cast(stag2.CDMEMBERINDEX as varchar(255)) as bigint) <
              cast(cast(stag.NRCYCLE as varchar(255))+cast(stag.FGSTAGE as varchar(255))+cast(stag.NRSEQUENCE as varchar(255))+cast(stag.CDMEMBERINDEX as varchar(255)) as bigint)
         and stag2.dtapproval is not null) and stag3.cdrevision = rev.cdrevision),stag.DTAPPROVAL)
  end leadtime
, his.dtaccess as dtcancel
, his.NMREVISION as revcancel, his.nmuser, cast(his.dsjustify as varchar(4000)) as justificativa
