...
WHERE str.idstruct = 'Decisão14102914536874' and str.idprocess=wf.idobject), cast('1970-01-01' as datetime)) > coalesce((SELECT max(str.DTEXECUTION+str.TMEXECUTION) as atv_approv3 FROM WFSTRUCT STR
