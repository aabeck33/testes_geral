...
, case when req.DTREQUEST is null then req.DTREQUEST else gnrev.DTREVCREATE end as ReqAtendida--, req.DTREQUESTENDDATE as ReqFechada
...
where rev.cdcategory in ( 219, 220, 221, 222, 223, 257, 258, 259, 260)
